        ...
        >
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input defaultValue={updateItem?.origin} name="origin" type="text" className="input input-sm input-bordered w-full" placeholder="Country of origin" required />
                </div>

                <div>
                    <label className="block text-sm font-medium">Case Metal</label>
                    <input defaultValue={updateItem?.caseMetal} name="caseMetal" type="text" className="input input-sm input-bordered w-full" placeholder="ex. Stainless Steel" required />
                </div>
                ...
                <div>
                    ...
                    <input defaultValue={updateItem?.braceletMaterial} name="braceletMaterial" type="text" className="input input-sm input-bordered w-full" placeholder="ex. Leather" required />
                </div>

                <div>
                    <label className="block text-sm font-medium">Glass Type</label>
                    <input defaultValue={updateItem?.glassType} name="glassType" type="text" className="input input-sm input-bordered w-full" placeholder="ex. Sapphire" required />
                </div>

                <div>
                    <label className="block text-sm font-medium">Color</label>
                    <input defaultValue={updateItem?.color} name="color" type="text" className="input input-sm input-bordered w-full" placeholder="ex. Blue" required />
                </div>
                ...
                <div>
                    ...
                    <input defaultValue={updateItem?.price} name="price" type="number" className="input input-sm input-bordered w-full" placeholder="ex. 9000" />
                </div>
                <div>
