...
const Register = () => {
  ...
  return (
    ...
    >
      <Seo
        title={"Register | Kashem Optical"}
        content={
          "Create a new account at Kashem Optical to shop lenses and eyewear with ease."
        }
        link={"/register"}
      ></Seo>
      <div className="flex flex-col lg:flex-row shadow-lg rounded-lg bg-white max-w-4xl w-full">
        ...
        <div className="bg-neutral  text-white p-8 lg:w-1/2 flex flex-col justify-center items-center rounded-l-lg md:rounded-tr-[100px] md:rounded-br-[100px]">
          ...
          <Link
            to="/login"
            className="bg-white text-purple-700 hover:bg-gray-200 px-6 py-2 rounded-xl font-medium transition"
          >
            SIGN IN
          </Link>
        </div>
          ...
          >
            ...
            {errors.name && (
              <p className="text-red-500 mb-1 inline-flex items-center gap-1 text-sm">
                {" "}
                <IoWarningOutline /> Name is Required
              </p>
            )}
            <input
              {...register("email", {
            ...
            {errors.email && (
              <p className="text-red-500 mb-1 inline-flex items-center gap-1 text-sm">
                {" "}
                <IoWarningOutline /> Invalid Email
              </p>
            )}
            ...
            {errors.password && (
              <p className="text-red-500 mb-1 inline-flex items-center gap-1 text-sm">
                {" "}
                <IoWarningOutline /> Password is Required
              </p>
            )}
            {errors.password?.type === "minLength" && (
              <p className="text-red-500 mb-1 inline-flex items-center gap-1">
                {" "}
                <IoWarningOutline /> Password Must be more than 6 Character{" "}
              </p>
            )}
            <motion.div
              initial={{ y: 20, opacity: 0 }}
