      ...
      <div className="drawer-side ">
        ...
        <div className="bg-base-200 w-64 flex flex-col justify-between  min-h-full fixed z-10">
          ...
          <div className="flex-grow">
            <p
              style={{ fontVariant: "small-caps" }}
              className=" leading-10 pl-6 text-start text-2xl lg:hidden"
            >
              Menu
            </p>
            <hr />
            ...
            {isAdmin ? (
              ...
              >
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `flex items-center gap-3 ${
                        isActive
                          ? "-ml-2 rounded-md bg-neutral text-white p-2 opacity-100"
                          : "text-slate-800 opacity-80"
                      }`
                    }
                  >
                    <ChartNoAxesCombined className="text-xs w-4 h-4"></ChartNoAxesCombined>{" "}
                ...
                <li>
                  ...
                  >
                    <UserRoundCog className="text-xs w-4 h-4"></UserRoundCog>{" "}
                ...
                <li>
                  ...
                  >
                    <LayoutGrid className="text-xs w-4 h-4"></LayoutGrid>{" "}
                ...
                <li>
                  ...
                  >
                    <Store className="text-xs w-4 h-4"></Store>{" "}
                ...
                <li>
                  ...
                  >
                    <TicketSlash className="text-xs w-4 h-4"></TicketSlash>{" "}
              ...
              <MenuItems className="absolute bottom-full mb-2 w-52 origin-bottom-right rounded-xl border border-black/10 bg-base-100 p-1 text-sm text-black">
                <MenuItem>
                  <button
                    ...
                    className="group flex items-center gap-2 font-medium w-full text-left px-4 py-2 hover:bg-base-200 hover:rounded-md"
                  >
                ...
                <MenuItem>
                  {user ? (
                    <button
                      ...
                      className="group flex gap-2 items-center font-medium w-full text-left px-4 py-2 hover:bg-base-200 hover:rounded-md text-red-500"
                    >
                    ...
                    <Link
                      to={"/login"}
                      className="group flex gap-2 items-center font-medium w-full text-left px-4 py-2 hover:bg-base-200 hover:rounded-md text-green-500"
                    >
