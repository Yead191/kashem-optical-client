...
import { BaggageClaim, Filter } from 'lucide-react';
...
const Products = () => {
    ...
    useEffect(() => {
        ...
        refetch(); // Refetch data when searchTerm or selectedCategory changes
        ...
        <div className='bg-base-100'>
            ...
            <div className='flex justify-between items-center container mx-auto p-2 my-12'>
                ...
                <div className='flex items-center gap-2'>
                    {
                        selectedCategory && <p className='text-sm text-slate-800'>Selected: {selectedCategory}</p>
                    }
                    <div className="relative">
            ...
            <div className='container mx-auto my-12 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 p-2'>
                {products?.map(product =>
                    <div key={product._id} className="rounded-xl bg-white shadow-lg hover:border hover:border-[#b21000] flex flex-col">
                        <img className="mx-auto pt-8 px-2 mb-7 object-cover h-[180px] md:h-[200px] lg:h-[260px]" src={product?.image} alt="" />
                        ...
                        <div className='w-11/12 mx-auto mb-4'>
                            {product?.status === "In Stock" ? (
                                <button className='btn w-full btn-sm flex items-center gap-2 hover:btn-neutral'>
